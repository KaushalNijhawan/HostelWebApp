...
class LoggedInNabar extends React.Component{
   render(){
       return(
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav">
            <li className="nav-item active">
              <a className="nav-link" href="/profiles">About Us <span className="sr-only">(current)</span></a>
            </li>
        ...
        <ul className="navbar-nav">
          <li className="nav-item">
       <a className="nav-link mr-sm-2" href="/login" style={{align:"right" , paddingTop:"14px" ,paddingRight:"80px"}}>{"Hello " +this.props.name + "!"}</a>
            </li>
            <li className="nav-item">
              <a className="nav-link my-2 my-sm-0" href="/" tabIndex="-1" ><i class="fas fa-sign-out-alt fa-2x"></i></a>
            </li>
